...
public class ServiceStarter {
    ...
    private static final Logger serviceLogger = LoggerFactory.getLogger("rim-medarbejder-web");
    ...
    public GenericContainer startServicesInDocker() {
        ...
        var resourcesContainerName = "rim-medarbejder-web-resources";
        ...
        if (resourcesRunning) {
            ...
            service = new GenericContainer<>("local/rim-medarbejder-web-qa:dev")
        ...
        service.withNetwork(dockerNetwork)
                .withNetworkAliases("rim-medarbejder-web")
